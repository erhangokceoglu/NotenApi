...
import { Container, Navbar, Row, Col, ListGroup, ListGroupItem, Button, Form, FormGroup } from 'react-bootstrap';
import './App.css';

function App() {
  const apiRoot = "https://localhost:7283/api/Notes"
    ...
    <div className="App">
      ...
      <Container fluid>
        <Row>
          ...
          <ListGroupItem key= {note.id} action active={selectedIndex===index} onClick={(e) => openNote(e, note, index)}>{note.title}
          </ListGroupItem>)}
           </ListGroup>
          </Col>
          <Col sm={8} md={9}>
            <Form onSubmit={handleSubmit}>
              ...
              <FormGroup className='mb-3'>
                <Form.Control as="textarea" type="text" placeholder = "Content" rows={10} value={content} 
